...
class DeepEmbeddingClustering(object):
    ...
    def initialize(self, X, save_autoencoder=False, name='autoencoder', layerwise_pretrain_iters=50000, finetune_iters=100000):
        if self.pretrained_weights is None:
            ...
            if save_autoencoder:
                self.autoencoder.save_weights(f'{name}.h5')
        else:
    ...
    def cluster(self, X, y=None,
        ...
        while train:
            ...
            iteration += 1
            #sys.stdout.flush()
        return self.DEC.predict(X, verbose=0)
